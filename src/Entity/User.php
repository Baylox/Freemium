...
#[UniqueEntity(fields: ['email'], message: 'There is already an account with this email, sorry')] // This is a validation constraint for the email field
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\Column]
    private bool $isVerified = false; // This is the boolean field for checking if the user has a verified email

    public function __construct()
    {
        $this->createdAt = new \DateTime(datetime: 'now');
        $this->isVerified = false;
        $this->tokenRegistrationLifeTime = (new \DateTime(datetime: 'now'))->add(new \DateInterval(duration: 'P1D')); // The token will be valid for 1 day
    }
